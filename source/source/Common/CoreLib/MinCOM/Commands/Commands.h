#ifndef COMMANDS_H__MINCOM__COMMONKIT__INCLUDED_
#define COMMANDS_H__MINCOM__COMMONKIT__INCLUDED_
...
#endif // !COMMANDS_H__MINCOM__COMMONKIT__INCLUDED_
